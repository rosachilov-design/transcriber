...
HF_TOKEN = os.getenv("HF_TOKEN", "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")
...
def transcribe_core(file_path: Path):
    ...
    return {"timeline": timeline, "result": smoothed}
...
def handler(event):
    ...
    try:
         result = transcribe_core(local_path)
    finally:
